                    ...
                    <div class="card text-start rounded-4 p-3">
                        ...
                        <div class="card-body d-flex justify-content-between">
                            ...
                            <div class="wrapper-rating w-50 d-inline-block">
                                ...
                                <p style="background-color:#ffeecb; color:#EB9B00; " class="text-warning ms-auto px-2 w-50 w-md-100 text-center rounded-5">5 <i class="bi bi-star-fill"></i></p>
                        ...
                        <div class="card-body d-block d-md-flex">
                            ...
                            <div class="wrapper-addCart w-100 w-md-50 d-block d-md-flex">
                                <a class="btn btn-dark w-100 my-1 my-md-0 rounded-5">checkout<i class="mx-1 bi bi-basket-fill"></i></a>
                                <a class="btn btn-dark w-100 my-1 my-md-0 rounded-5 ms-md-1">add cart<i class="mx-1 bi bi-cart-check-fill"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
